...
/// The default theme family for Oxidian.
///
...
pub fn zed_default_themes() -> ThemeFamily {
    ThemeFamily {
        id: "oxidian-default".to_string(),
        name: "Oxidian Default".into(),
        author: "Oxidian Team".into(),
...
pub(crate) fn zed_default_dark() -> Theme {
    let bg = hsla(220. / 360., 13. / 100., 8. / 100., 1.);
    ...
    let teal = hsla(160. / 360., 70. / 100., 45. / 100., 1.0);
